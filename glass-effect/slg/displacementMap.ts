 ...
 * `src/core/displacementMap.ts`, MIT License © lucaperullo. Keep in sync with upstream
 * when upgrading.
 *
 ...
 * field to neutral at the rim so the pane reads as single lens instead of a split.
 */
